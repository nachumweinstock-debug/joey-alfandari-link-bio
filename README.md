...
- Admin video editing: click the footer fire emoji, enter `3907`, choose an iPhone, then edit the label/title and upload a video. Use `Add iPhone` to create more video slots.
