...
- Admin video editing: click the footer fire emoji, enter `3907` or `joey`, choose an iPhone, then edit the label/title and upload a video. Scrub the upload preview and click `Use Current Frame as Thumbnail` before saving.
- Use `Add iPhone` to create more video slots.
